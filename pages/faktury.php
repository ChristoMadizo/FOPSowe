...
//po kliknięciu "Twórz fakturę" - pyta czy tworzyć fakturę i uruchamia skrypt Pythona do do interakcji z FAKT
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'tworz_fakture' && $_POST['confirmation']==='yes'){
    ...
    } else {  //czyli gdy kliknięto "Twórz fakturę" i nie potwierdzono
        $_SESSION['msg'] = 'no';
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {   //czy w ogóle wchodzi w ten fragment kodu
